...
namespace WindowsFormsApp11
{
    ...
    public class Program1
    {
        ...
        public static void recog()
        {
            ...
            config.Add("access_key", "2c4e84705795ede2f04cf96251af3777");
            config.Add("access_secret", "ZLnjXdhP5AirbnRPJJgCXuZttbGbVlpVgvY7dmnR");
            ...
            string result = re.RecognizeByFile("Done It Before.mp3", 0);
            ...
            /**
              ...
              * 
              **/
            using (FileStream fs = new FileStream(@"Done It Before.mp3", FileMode.Open))
            {
